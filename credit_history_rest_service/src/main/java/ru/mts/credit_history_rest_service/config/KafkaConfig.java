package ru.mts.credit_history_rest_service.config;
...
public class KafkaConfig {
    @Bean
    public ProducerFactory<String, StatusData> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, StatusData> kafkaTemplate() {
